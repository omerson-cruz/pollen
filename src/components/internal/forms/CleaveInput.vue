...
// When we need to add international number support...
// https://github.com/nosir/cleave.js/blob/master/doc/phone-lib-addon.md
import 'cleave.js/dist/addons/cleave-phone.us';

/**
 * Input element with Cleave applied. Largely adapted from:
...
export default {
  ...
  methods: {
    ...
    getOptions(options) {
      ...
      return { ...options, onValueChanged: this.onValueChanged };
    },
    /**
